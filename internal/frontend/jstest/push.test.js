...
test("drop onto an occupied slot pushes the overlapped block down", () => {
	const current = [
		{ id: "a", slot: 18, span: 1 },
		{ id: "b", slot: 20, span: 1 },
	];
...
test("a push that would force a block past the day end rejects whole", () => {
	const current = [
		{ id: "a", slot: 18, span: 1 },
...
test("contiguous blocks chain-push together", () => {
	const current = [
		{ id: "a", slot: 18, span: 1 },
		{ id: "b", slot: 20, span: 2 },
		{ id: "c", slot: 22, span: 1 },
...
test("a block straddling the drop run is pushed fully below it", () => {
	const current = [
		{ id: "a", slot: 30, span: 1 },
