...
- `task test` — `go test ./...` plus the JS unit tests under `internal/frontend/static/js/`. Single Go test: `go test ./internal/block -run TestSetLayout`. CI runs `go test -race`; `task test:browser` runs the Jotpad smoke in Chromium.
